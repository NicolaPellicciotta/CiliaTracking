function [fig_handle, axes_handle, scroll_bar_handles, scroll_func] = ...
	videofig(num_frames, redraw_func, movie_obj, play_fps, big_scroll, ...
	key_func, varargin)
...
%   João Filipe Henriques, 2010
	...
	if nargin < 4 || isempty(play_fps), play_fps = 25; end  %play speed (frames per second)
	if nargin < 5 || isempty(big_scroll), big_scroll = 30; end  %page-up and page-down advance, in frames
